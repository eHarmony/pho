...
public class LegacyMatchFeedTransformer {
    ...
    public static LegacyMatchDataFeedDto transform(final Set<MatchDataFeedItemDto> hbaseFeedItems) {
    ...
    private static Map<String, Map<String, Object>> buildLegacyFeedItem(MatchDataFeedItemDto matchDataFeedItemDto) {
	...
	private static Map<String, Object> createMatchFeedProfile(
        ...
        profile.put(MatchFeedModel.PROFILE.BIRTHDATE, elem.getBirthdate());
    ...
    private static Map<String, Object> createMatchFeedMatch(
        ...
        match.put(MatchFeedModel.MATCH.CLOSED_DATE, matchElem.getClosedDate());
        match.put(MatchFeedModel.MATCH.CLOSED_STATUS, matchElem.getClosedStatus());
        match.put(MatchFeedModel.MATCH.DELIVERED_DATE, matchElem.getDeliveredDate());
        ...
        match.put(MatchFeedModel.MATCH.STATUS,  matchElem.getStatus());
        ...
        match.put(MatchFeedModel.MATCH.CHOOSE_MHCS_DATE, commElem.getChooseMhcsDate());
        ...
        match.put(MatchFeedModel.MATCH.LAST_NUDGE_DATE, commElem.getLastNudgeDate());
        match.put(MatchFeedModel.MATCH.STAGE, commElem.getStage());
        match.put(MatchFeedModel.MATCH.COMM_STARTED_DATE, commElem.getCommStartedDate());
        match.put(MatchFeedModel.MATCH.NUDGE_STATUS, commElem.getNudgeStatus());
        match.put(MatchFeedModel.MATCH.READ_DETAILS_DATE, commElem.getReadDetailsDate());
